...
14. **Product shipping dimensions** — Shipment payloads use actual `Product.weightGrams/lengthCm/widthCm/heightCm` with a 20% packaging weight buffer. Never rely on hardcoded defaults for production orders.
